...
public class RCC_Editor : Editor {
	...
	private void SteeringTab() {
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("useSteeringLimiter"), new GUIContent("Use Steering Limiter", "Limits steering while sliding."));
		EditorGUILayout.PropertyField(serializedObject.FindProperty("useCounterSteering"), new GUIContent("Use Counter Steering", "Limits steering while sliding."));
		...
		if (carScript.useSteeringSensitivity)
			EditorGUILayout.PropertyField(serializedObject.FindProperty("steeringSmootherFactor"), new GUIContent("Steering Smoother", "Steering smoother multiplier."));
	...
	private void DamageTab() {
		...
		if (carScript.useDamage) {
			...
			EditorGUILayout.PropertyField(serializedObject.FindProperty("wheelDamage"), new GUIContent("Wheel Damage"), false);
			EditorGUILayout.Space();
